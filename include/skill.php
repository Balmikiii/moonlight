<div class="skill-area bg-relative bg-sky pd-top-120 pd-bottom-120">
        <img class="half-bg-right" src="assets/img1/bg/4.webp" alt="img">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pe-5 mb-5 mb-lg-0">
                    <div class="section-title mb-0">
                        <h5 class="sub-title right-line">Professional Skill </h5>
                        <h3 class="title">We have professional skilled </h3>
                        <p class="content">Our team skiled for working.</p>
                    </div>
                    <div class="skill-progress-area mt-4">
                        ...
                        <div class="single-progressbar">
                            ...
                            <div class="progress-item" id="progress-running-2">
                                <div class="progress-bg">
                                    <div id="progress-2" class="progress-rate" data-value="85">
                                    </div>
                                    <div class="progress-count-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="thumb border-radius-5 mb-4 mb-md-0 image-hover-animate">
                                <img src="assets/img1/other/12.jpg" alt="img">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="thumb border-radius-5 mb-4 image-hover-animate">
                                <img src="assets/img1/other/1.jpg" alt="img">
                            </div>
                            <div class="thumb border-radius-5 image-hover-animate">
                                <img src="assets/img1/other/2.jpg" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
